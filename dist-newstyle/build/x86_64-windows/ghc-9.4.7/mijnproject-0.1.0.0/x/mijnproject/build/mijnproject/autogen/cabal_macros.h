...
/* package mijnproject-0.1.0.0 */
#ifndef VERSION_mijnproject
#define VERSION_mijnproject "0.1.0.0"
#endif /* VERSION_mijnproject */
#ifndef MIN_VERSION_mijnproject
#define MIN_VERSION_mijnproject(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_mijnproject */
...
#define CURRENT_COMPONENT_ID "mijnproject-0.1.0.0-inplace-mijnproject"
